...
description:
  Enhanced integration with GraphQL servers, deprecating `@lib/client` and adding support for
  Cloudflare Workers.
date: 2024-04-23
authors: [kamil]
---
...
<Callout type="warning">
  As part of this update, we'll be sunsetting the @lib/client package in favor of new specialized
  packages.
</Callout>
...
1. Remove `@lib/client` from your dependencies.
1. Install `@lib/yoga`.
...
- import { createHive } from '@lib/client';
...
import { createYoga } from 'graphql-yoga'
import { createHive, useHive } from '@lib/yoga'
