...
Upgrade [`@lib/yoga@0.41.0`](/docs/other-integrations/graphql-yoga) to at least version
...
Upgrade [`@lib/apollo`](https://the-guild.dev/graphql/hive/docs/other-integrations/apollo-server) to
at least version
...
Upgrade [`@lib/envelop`](/docs/other-integrations/envelop) to at least version
...
Upgrade `@lib/core` to at least version
