...
The `@lib/apollo` package exports a
...
You can report usage to the Hive registry by using the `@lib/apollo` package. Depending on your
GraphQL server setup the configuration might differ.
