...
The `@lib/envelop` package exports an [Envelop plugin](https://the-guild.dev/graphql/envelop), that
can be used directly with any server that supports Envelop.
...
- [`@lib/envelop` source code](https://github.com/graphql-hive/platform/tree/main/packages/libraries/envelop)
